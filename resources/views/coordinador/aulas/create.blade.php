            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div class="col-span-2">
                    <label for="id_aula" class="block text-sm font-medium text-gray-700 mb-2">
                        Identificador del Aula <span class="text-red-500">*</span>
                    </label>
                    <input type="text" name="id_aula" id="id_aula" required
                           ...
                           placeholder="Ej: A-101, LAB-02, AUD-01">
                    @error('id_aula')
                ...
                <div>
                    ...
                    <select name="tipo_aula" id="tipo_aula" required
                        ...
                        <option value="sala_juntas" {{ old('tipo_aula') == 'sala_juntas' ? 'selected' : '' }}>Sala de Juntas</option>
                    </select>
                    @error('tipo_aula')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
