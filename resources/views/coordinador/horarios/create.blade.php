...
<head>
    ...
    <title>Registrar Horario - Glotty</title>
        ...
        <div class="flex-1 flex flex-col">
            ...
            <header class="bg-white shadow-sm h-16 flex items-center px-6 border-b">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-gray-400 mx-2">/</span>
                    <span class="text-gray-600">Registrar Horario</span>
                </div>
            ...
            <div class="flex-1 p-6 overflow-auto">
                ...
                <div class="max-w-md mx-auto bg-white rounded-lg shadow-sm">
                    ...
                    <div class="p-6 border-b">
                        <h2 class="text-2xl font-bold text-gray-800 text-center">Registrar Horario</h2>
                    </div>
                    
                    <!-- Form -->
                    <div class="p-6 pt-2">
                    <form action="{{ route('coordinador.horarios.guardar') }}" method="POST">
                    @csrf
