...
@section('header-title', 'Crear Nuevo Horario')

@section('content')
    <div class="bg-white rounded-2xl shadow-card p-6 max-w-2xl mx-auto">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-2">Nuevo Horario</h2>
            <p class="text-gray-600">Complete la información del nuevo horario</p>
        </div>
                ...
                <div>
                    ...
                    <div class="flex space-x-6 mt-2">
                        <div class="flex items-center space-x-3">
                            ...
                            <label for="activo_si" class="text-sm font-medium text-gray-700">Activar este horario</label>
                        </div>
                        <div class="flex items-center space-x-3">
                            <input type="radio" id="activo_no" name="activo" value="0"
                                   {{ old('activo') == '0' ? 'checked' : '' }}
                                   class="w-5 h-5 text-blue-600 border-gray-300 focus:ring-blue-500">
                            <label for="activo_no" class="text-sm font-medium text-gray-700">Mantener inactivo</label>
                        </div>
                    </div>
                </div>
            </div>
