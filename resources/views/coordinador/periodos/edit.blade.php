...
@section('header-title', 'Editar Periodo Académico')

@section('content')
<div class="bg-white rounded-2xl shadow-card p-6 max-w-2xl mx-auto">
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800 mb-2">Editar Periodo Académico</h2>
        <p class="text-gray-600">Modifique la información del periodo académico</p>
    </div>

    <form action="{{ route('coordinador.periodos.update', $periodo->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="col-span-2">
                ...
                <select name="nombre" id="nombre" required
                    ...
                    <option value="AGOSTO-DIC" {{ $periodo->nombre == 'AGOSTO-DIC' ? 'selected' : '' }}>AGOSTO-DICIEMBRE</option>
                    <option value="ENERO-JUNIO" {{ $periodo->nombre == 'ENERO-JUNIO' ? 'selected' : '' }}>ENERO-JUNIO</option>
                    <option value="INVIERNO" {{ $periodo->nombre == 'INVIERNO' ? 'selected' : '' }}>INVIERNO</option>
                    <option value="VERANO1" {{ $periodo->nombre == 'VERANO1' ? 'selected' : '' }}>VERANO 1</option>
                    <option value="VERANO2" {{ $periodo->nombre == 'VERANO2' ? 'selected' : '' }}>VERANO 2</option>
                </select>
                @error('nombre')
        ...
        <div class="bg-gray-50 rounded-xl p-4 mb-6">
            <h4 class="font-semibold text-gray-800 mb-2">Información del Periodo</h4>
