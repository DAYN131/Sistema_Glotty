...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <!-- Tarjeta Alumnos -->
   <a href="{{ route('coordinador.usuarios.index') }}" class="bg-slate-50 p-6 rounded-2xl shadow-card hover:shadow-card-hover transition-smooth border border-slate-200 card-hover group">
        <div class="flex items-center mb-5">
