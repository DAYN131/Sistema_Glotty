...
class Preregistro extends Model
{
    ...
    protected $fillable = [
        ...
        'semestre_carrera',
        'grupo_asignado_id',
        'estado',           // Se incluye para asignaciones manuales por el coordinador
        'pagado',           // Se incluye para actualizar el estado de pago
    ];
    ...
    protected $casts = [
        ...
        // 'created_at' y 'updated_at' ya son timestamps por defecto
    ];
    ...
    // 6. Métodos de ayuda/alcances personalizados (Opcional, pero útil)
